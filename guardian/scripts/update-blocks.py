...
def build_policy_config():
    ...
    iot_workflow = block("interfaceContainerBlock", "iot_workflow",
        ...
        children=[
            ...
            block("interfaceStepBlock", "ce_intake_steps",
                ...
                children=[
                    ...
                    block("switchBlock", "compliance_router",
                        ...
                        events=[
                            {"source": "compliance_router", "target": "associate_ggcc",
                             "input": "RunEvent", "output": "mint_ggcc_path",
                             "actor": "", "disabled": False},
                            {"source": "compliance_router", "target": "associate_zviol",
            ...
            # Token association + mint blocks — triggered by switchBlock events
            # tokenActionBlock auto-associates token for user, then passes doc to mintDocumentBlock
            block("tokenActionBlock", "associate_ggcc",
                permissions=["IoT"],
                tokenId=GGCC_TOKEN_ID,
                action="associate",
                accountType="default",
                events=[
                    {"source": "associate_ggcc", "target": "mint_ggcc_block",
                     "input": "RunEvent", "output": "RunEvent",
                     "actor": "", "disabled": False},
                ],
            ),
            ...
            block("tokenActionBlock", "associate_zviol",
                permissions=["IoT"],
                tokenId=ZVIOL_TOKEN_ID,
                action="associate",
                accountType="default",
                events=[
                    {"source": "associate_zviol", "target": "mint_violation_block",
                     "input": "RunEvent", "output": "RunEvent",
                     "actor": "", "disabled": False},
                ],
            ),
